<?php
	...
	$namaPageUtama		= 'newsauthor.php';
	$namaFolderUpload	= 'newsauthor';				// If any
	$maxFilePxUpload	= '125x128';				// If any
	
	$pageType 			= 'detail';					// list OR detail OR overview
	$id					= ue_real_escape_string($_GET['id']);
	$pageTitle			= 'News Author';
...
<div class="transFullWidthWrapper" id="ueFormContainer">
    ...
    <form enctype="multipart/form-data" method="post" action="action-newsauthor.php">
