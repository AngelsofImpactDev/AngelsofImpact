...
<div class="transFullWidthWrapper" id="ueFormContainer">
    ...
    <form enctype="multipart/form-data" method="post" action="action-adminlist.php">
    	...
    	<table id="detailPageTable" width="100%">
        	<tr>
                ...
                <td>
                	<?php echo ueCreateInputText('name','',$detailmodeeditRes["$namaTableDatabase".'_username'])?>
                </td>
            </tr>
        	<tr>
            	<td>
        	...
        	<tr>
            	<td>
                	<?php echo $pageTitle?> Re-Password
                </td>
                <td align="center">
                	:
                </td>
        	...
        	<tr>
                ...
                <td>
                    ...
                    ?>
                    <?php
                        $namaTableDatabaseSel = 'adminuserlevel';
                        $promotypeQue = ue_query("SELECT * FROM $namaTableDatabaseSel WHERE ".$namaTableDatabaseSel."_enabled = 'e' ORDER BY ".$namaTableDatabaseSel."_id DESC");
                    ...
                    ?>
                    <?php echo ueCreateSelectOption($currentSelectArr,'',$detailmodeeditRes['adminuserlevel_id'])?>
                </td>
            </tr>
            <tr>
				<td width="150">
