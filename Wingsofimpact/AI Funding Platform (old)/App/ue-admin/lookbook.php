<?php
	...
	$namaHalamanEdit	= 'detail-lookbook.php';
	$namaFolderUpload	= 'lookbook';
...
<table class="multiDataViewTable" width="100%">
    ...
    ?>
        <tr<?php $rowMode = $currentRowNumber % 2; if($rowMode != 1) { echo ' class="even"'; } else { echo ' class="odd"'; } ?>>
            ...
            <td align="center">
            	<a href="detail-imagelookbook.php<?php echo $pageParams?>&id=<?php echo $mainQueryRes["$namaTableDatabase".'_id']?>&imagelisttable=sliderimage&detailmode=edit"><img src="images/icon/picture.png" /></a>
            </td>
            <td align="center">
            <?php
