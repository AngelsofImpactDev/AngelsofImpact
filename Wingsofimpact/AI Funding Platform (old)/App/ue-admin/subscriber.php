...
<table class="multiDataViewTable" width="100%">
        <tr>
            ...
            <td width="150">
            <a href="<?php echo pageParamsFormat($pageParamsArr,array('orderwhat' => $namaTableDatabase.'_source', 'orderby' => ueColumnSort()))?>">
                Source
            </a>
            </td>
            <td>
    ...
    ?>
        <tr<?php $rowMode = $currentRowNumber % 2; if($rowMode != 1) { echo ' class="even"'; } else { echo ' class="odd"'; } ?>>
            ...
            <td align="center">
                <label for="<?php echo $mainQueryRes["$namaTableDatabase".'_id']?>"><?php echo wordlimiter(nohtml($mainQueryRes["$namaTableDatabase".'_source']),120)?></label>
            </td>
            <td>
