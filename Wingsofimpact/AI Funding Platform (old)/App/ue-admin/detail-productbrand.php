<?php
	...
	$namaTableDatabase	= 'productbrand';
	$namaPageUtama		= 'productbrand.php';
	$namaFolderUpload	= 'productBrandImage';		// If any
...
<div class="transFullWidthWrapper" id="ueFormContainer">
    ...
    <form enctype="multipart/form-data" method="post" action="action-productbrand.php">
