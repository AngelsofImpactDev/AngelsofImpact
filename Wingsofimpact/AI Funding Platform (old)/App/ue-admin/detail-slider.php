<?php
	...
	$namaPageUtama		= 'slider.php';
	$namaFolderUpload	= 'sliderImage';		// If any
	$maxFilePxUpload	= '1440x540';			// If any
...
<div class="transFullWidthWrapper" id="ueFormContainer">
    ...
    <form enctype="multipart/form-data" method="post" action="action-slider.php">
