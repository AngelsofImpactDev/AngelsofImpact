<?php
	...
	$namaHalamanEdit	= 'detail-campaign.php';
	$namaFolderUpload	= 'campaign';
...
<table class="multiDataViewTable" width="100%">
    ...
    ?>
        <tr<?php $rowMode = $currentRowNumber % 2; if($rowMode != 1) { echo ' class="even"'; } else { echo ' class="odd"'; } ?>>
            ...
            <td align="center">
                <a href="analyticsoverview.php?id=<?php echo $mainQueryRes["$namaTableDatabase".'_id']?>"><img src="images/icon/analytics.png" /></a>
            </td>
            <td align="center">
            <?php
	            if($_GET['swapperSelf'] != '') {
