<?php
	...
	$namaTableDatabase	= 'testimonial';
	$namaPageUtama		= 'testimonial.php';
	$namaFolderUpload	= 'testimonial';			// If any
	$maxFilePxUpload	= '80x80';					// If any
...
<div class="transFullWidthWrapper" id="ueFormContainer">
    ...
    <form enctype="multipart/form-data" method="post" action="action-testimonial.php">
    	...
    	<table id="detailPageTable" width="100%">
        	...
        	<tr>
                ...
                <td>
                	<?php echo ueCreateInputText('url','',$detailmodeeditRes["$namaTableDatabase".'_url'])?>
                </td>
            </tr>
        	<tr>
            	<td width="150">
                ...
                <td>
					<?php echo ueCreateInputTextareaRTF('desc','',$detailmodeeditRes["$namaTableDatabase".'_desc'])?>
                </td>
            </tr>
        	<tr>
            	<td width="150">
