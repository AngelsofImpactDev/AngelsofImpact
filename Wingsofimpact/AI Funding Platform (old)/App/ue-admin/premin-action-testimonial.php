<?php
	...
	//Pattern Check START
	if($auPostedElements['url'] == '') {
		$auPostedElements['url'] = '#';
	}
	//Pattern Check END
	
	if(count($errorList) == 0) {
		//Fixed Vars
		$sliderFolderLocation	= '../upload/testimonial';
		$sliderMaxWidth			= 80;
		$sliderMaxHeight		= 80;
		...
		switch($detailmode) {
			case 'edit':
				...
				$editQueryStr	= "UPDATE ".$namaTableDatabase." SET
									...
									".$namaTableDatabase."_url = '".$auPostedElements['url']."',
