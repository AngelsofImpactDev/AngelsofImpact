<?php
	...
	$namaTableDatabase	= 'bank';
	$namaPageUtama		= 'bank.php';
	$namaFolderUpload	= 'bankLogo';				// If any
	$maxFilePxUpload	= '100x35';					// If any
...
<div class="transFullWidthWrapper" id="ueFormContainer">
    ...
    <form enctype="multipart/form-data" method="post" action="action-bank.php">
    	...
    	<table id="detailPageTable" width="100%">
        	...
        	<tr>
            	<td>
                	<?php echo $pageTitle?> Brief Desc*
                </td>
                <td align="center">
                	:
                </td>
                <td>
                	<?php echo ueCreateInputTextareaRTF('briefdesc','',$detailmodeeditRes["$namaTableDatabase".'_briefdesc'])?>
                </td>
            </tr>
        	<tr>
            	<td>
        	...
        	<tr>
                ...
                <td>
					<?php
						$imageUploadFolder = '../upload/bankLogo/';
					?>
                	<?php
