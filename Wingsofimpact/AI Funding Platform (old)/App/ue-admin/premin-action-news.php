<?php
	...
	if(count($errorList) == 0) {
		//Fixed Vars
		$sliderFolderLocation	= '../upload/news';
		$sliderMaxWidth			= 458;
		$sliderMaxHeight		= 244;
		...
		switch($detailmode) {
			case 'edit':
				...
				ueRTFIdeleteOrphan($editDetailRes[$namaTableDatabase.'_desc'],$auPostedElements['desc']);
				...
				$editQueryStr	= "UPDATE ".$namaTableDatabase." SET
									...
									newsauthor_id = '".$auPostedElements['author']."',
			...
			default:
				...
				ueRTFIdeleteOrphan('',$auPostedElements['desc']);
