<?php
	...
	$namaHalamanEdit	= 'detail-bank.php';
	$namaFolderUpload	= 'bankLogo';
...
<table class="multiDataViewTable" width="100%">
    ...
    ?>
        <tr<?php $rowMode = $currentRowNumber % 2; if($rowMode != 1) { echo ' class="even"'; } else { echo ' class="odd"'; } ?>>
            ...
            <td align="center">
            	<?
					if($mainQueryRes["$namaTableDatabase".'_paygate'] != '') {
				?>
                	<img src="images/icon/trashBw.png" class="tooltip" title="A payment gateway is integrated with this bank, unable to delete" />
                <?
					}
					else {
				?>
