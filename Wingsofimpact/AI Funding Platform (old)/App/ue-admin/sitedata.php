<?php
	...
	$namaHalamanEdit	= 'detail-sitedata.php';
	$namaFolderUpload	= '';
...
<table class="multiDataViewTable" width="100%">
        <tr>
            ...
            <td>
            <a href="<?php echo pageParamsFormat($pageParamsArr,array('orderwhat' => $namaTableDatabase.'_title', 'orderby' => ueColumnSort()))?>">
                Name
            </a>
            </td>
            <td width="50">
    ...
    <?php
        ...
        if($_GET['orderwhat'] != '') {
            ...
            if($_GET['orderby'] == 'asc') {
                $mainQueryString = $mainQueryString." ORDER BY ".$namaTableDatabase."_title ASC";
            }
            else {
                $mainQueryString = $mainQueryString." ORDER BY ".$namaTableDatabase."_title DESC";
            }
        }
    ...
    ?>
        <tr<?php $rowMode = $currentRowNumber % 2; if($rowMode != 1) { echo ' class="even"'; } else { echo ' class="odd"'; } ?>>
            ...
            <td>
                <?php echo wordlimiter(nohtml($mainQueryRes["$namaTableDatabase".'_title']),120)?>
            </td>
            <td align="center">
