<?php
	...
	$namaFolderUpload	= 'productImage';			// If any
	$maxFilePxUpload	= '380x553';				// If any
...
<div class="transFullWidthWrapper" id="ueFormContainer">
    ...
    <form enctype="multipart/form-data" method="post" action="action-imagelist.php">
...
<div id="multiImageUpload">
                    <?php
						...
						$multiImageEditPreviewTableName = 'productimage';
                    	...
                    	<table width="90%" id="eachMultiImageTable" class="eachMultiImageTableClass">
                        	<tr>
                                ...
                                <td style="font-weight: bold;">
                                	<input type="hidden" class="mainCheckRemoveInput" name="productimagedetaileditid[]" value="<?php echo $multiImageEditPreviewRes["$multiImageEditPreviewTableName".'_id']?>" />
			...
			?>
                            ...
                            <tr>
                            	<td>
                                    ...
                                    ?>
                                    <?php
                                        $namaTableDatabaseSel = 'productcolor';
                                        $promotypeQue = ue_query("SELECT * FROM $namaTableDatabaseSel WHERE ".$namaTableDatabaseSel."_enabled = 'e' AND ".$namaTableDatabase."_id = '$id' ORDER BY ".$namaTableDatabaseSel."_showorder DESC");
                                    ...
                                    ?>
                                    <?php echo ueCreateSelectOption($currentSelectArr,'',$multiImageEditPreviewRes['productcolor_id'])?>
                                </td>
