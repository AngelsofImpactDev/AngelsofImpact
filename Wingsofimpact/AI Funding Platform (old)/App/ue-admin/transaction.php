...
<table class="multiDataViewTable" width="100%">
    ...
    ?>
        <tr<?php $rowMode = $currentRowNumber % 2; if($rowMode != 1) { echo ' class="even"'; } else { echo ' class="odd"'; } ?>>
            ...
            <td>
                <label for="<?php echo $mainQueryRes["$namaTableDatabase".'_id']?>"><a style="font-weight:bold; color:#2472ab;" href="transactionlist.php?id=<?php echo $mainQueryRes['startup_id'] ?>"><?php echo wordlimiter(nohtml($mainQueryRes['startup_name']),120)?></a></label>
            </td>
			<td align="center">
