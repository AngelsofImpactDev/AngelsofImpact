<?php
	...
	if(count($errorList) == 0) {
		//Fixed Vars
		$sliderFolderLocation	= '../upload/productTypeImage';
		$sliderMaxWidth			= 749;
		$sliderMaxHeight		= 133;
		...
		switch($detailmode) {
			case 'edit':
				...
				$editQueryStr	= "UPDATE ".$namaTableDatabase." SET
									...
									productcategory_id = '".$auPostedElements[$auPostedElements['productclass']]."',
			...
			default:
				...
				$createQueryStr	= "INSERT INTO ".$namaTableDatabase." VALUES(
									...
									'0',
									'".$enableStat."',
									'".$auPostedElements[$auPostedElements['productclass']]."',
