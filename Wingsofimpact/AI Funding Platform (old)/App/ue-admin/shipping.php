<?php
	...
	$namaHalamanEdit	= 'detail-shipping.php';
	$namaFolderUpload	= '';
...
<table class="multiDataViewTable" width="100%">
        <tr>
            ...
            <td width="150">
            <a href="<?php echo pageParamsFormat($pageParamsArr,array('orderwhat' => $namaTableDatabase.'_area', 'orderby' => ueColumnSort()))?>">
                Area
            </a>
            </td>
            <td>
    ...
    <?php
        ...
        if($_GET['orderwhat'] != '') {
            ...
            if($_GET['orderby'] == 'desc') {
                $mainQueryString = $mainQueryString." ORDER BY ".$namaTableDatabase."_area DESC, ".$namaTableDatabase."_name DESC";
            }
            else {
                $mainQueryString = $mainQueryString." ORDER BY ".$namaTableDatabase."_area ASC, ".$namaTableDatabase."_name ASC";
            }
        }
    ...
    ?>
        <tr<?php $rowMode = $currentRowNumber % 2; if($rowMode != 1) { echo ' class="even"'; } else { echo ' class="odd"'; } ?>>
            ...
            <td align="center">
                <label for="<?php echo $mainQueryRes["$namaTableDatabase".'_id']?>"><?php echo $mainQueryRes["$namaTableDatabase".'_area']?></label>
            </td>
            <td>
