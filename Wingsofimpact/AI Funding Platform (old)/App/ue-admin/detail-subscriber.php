...
<div class="transFullWidthWrapper" id="ueFormContainer">
    ...
    <form enctype="multipart/form-data" method="post" action="action-subscriber.php">
    	...
    	<table id="detailPageTable" width="100%">
        	...
        	<tr>
            	<td>
                	<?php echo $pageTitle?> Source*
                </td>
                <td align="center">
                	:
                </td>
                <td>
                	<?php echo ueCreateInputText('source','admin',$detailmodeeditRes["$namaTableDatabase".'_source'])?>
                </td>
            </tr>
            <tr>
