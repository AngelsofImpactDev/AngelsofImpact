<?php
	...
	$namaTableDatabase	= 'advertising';
	$namaPageUtama		= 'advertising.php';
	$namaFolderUpload	= 'advertising';			// If any
	$advSizeArr			= array(
		1 => '360x359',
		2 => '360x359',
		3 => '360x359',
...
<div class="transFullWidthWrapper" id="ueFormContainer">
    ...
    <form enctype="multipart/form-data" method="post" action="action-advertising.php">
    	...
    	<table id="detailPageTable" width="100%">
        	<tr>
            	<td>
                	<?php echo $pageTitle?> Url*
                </td>
                <td align="center">
                	:
                </td>
                <td>
                	<?php echo ueCreateInputText('sliderurl','#',$detailmodeeditRes["$namaTableDatabase".'_url'])?>
                </td>
            </tr>
        	<tr>
            	<td>
                	<?php echo $pageTitle?> Target*
                </td>
                <td align="center">
                	:
                </td>
                <td>
					...
					?>
                	<?php echo ueCreateInputRadio($currentRadioArr,'_self','',$detailmodeeditRes["$namaTableDatabase".'_target'])?>
                </td>
            </tr>
        	<tr>
            	<td width="150">
                            ...
                            <tr>
                            	<td>
                                    ...
                                    <?php
										if($id) {
									?>
                                    	<i>*<?php echo $advSizeArr["$id"]?> Pixels Recommended</i>
                                    <?php
										}
									?>
                                </td>
