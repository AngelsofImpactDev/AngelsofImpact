<?php
	...
	$namaTableDatabase	= 'productgroup';
	$namaPageUtama		= 'productgroup.php';
	$namaFolderUpload	= 'productGroupImage';			// If any
...
<div class="transFullWidthWrapper" id="ueFormContainer">
    ...
    <form enctype="multipart/form-data" method="post" action="action-productgroup.php">
