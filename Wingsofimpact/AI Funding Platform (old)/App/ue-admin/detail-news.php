<?php
	...
	$namaTableDatabase	= 'news';
	$namaPageUtama		= 'news.php';
	$namaFolderUpload	= 'news';				// If any
	$maxFilePxUpload	= '458x244';			// If any
...
<div class="transFullWidthWrapper" id="ueFormContainer">
    ...
    <form enctype="multipart/form-data" method="post" action="action-news.php">
    	...
    	<table id="detailPageTable" width="100%">
        	<tr>
                ...
                <td>
                    ...
                    ?>
                    <?php
                        $namaTableDatabaseSel = 'newsauthor';
                    ...
                    ?>
                    <?php echo ueCreateSelectOption($currentSelectArr,'',$detailmodeeditRes['newsauthor_id'])?>
                </td>
            </tr>
        	<tr>
            	<td width="150">
        	...
        	<tr>
                ...
                <td>
					<?php echo ueCreateInputTextareaRTFI('desc','',$detailmodeeditRes["$namaTableDatabase".'_desc'])?>
                </td>
            </tr>
        	<tr>
            	<td width="150">
