<?php
	...
	if(count($errorList) == 0) {
		//Fixed Vars
		$sliderFolderLocation	= '../upload/adv';
		$advSizeArr			= array(
			1 => '360x359',
			2 => '360x359',
			3 => '360x359',
		...
		if($id) {
			$advSizeCur = explode('x',$advSizeArr["$id"]);
			$sliderMaxWidth			= (int)$advSizeCur['0'];
			$sliderMaxHeight		= (int)$advSizeCur['1'];
		}
