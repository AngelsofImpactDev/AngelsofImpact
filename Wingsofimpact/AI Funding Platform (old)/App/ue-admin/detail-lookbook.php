<?php
	...
	$namaFolderUpload	= 'lookbook';			// If any
...
<div class="transFullWidthWrapper" id="ueFormContainer">
    ...
    <form enctype="multipart/form-data" method="post" action="action-lookbook.php">
    	...
    	<table id="detailPageTable" width="100%">
        	...
        	<tr>
            	<td width="150">
                	<?php echo $pageTitle?> Products*
                </td>
                <td align="center">
                	:
                </td>
                <td>
		          <select data-placeholder="Choose a Product..." class="chosen-select" multiple style="width:350px;" name="prdlimit[]">
                    <?php
						...
						$preSelArr = explode(',',$detailmodeeditRes["$namaTableDatabase".'_productid']);
        	...
        	<tr>
				...
				<td>
					<?php
						$imageUploadFolder = '../upload/lookbook/';
					?>
                	<?php
						...
						<table width="90%" id="eachMultiImageTable" class="eachMultiImageTableClass">
                            ...
                            <tr>
                            	<td>
                                    ...
                                    <i>*550x300 Pixels Recommended</i>
                                </td>
