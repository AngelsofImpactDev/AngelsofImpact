<?php
	...
	$namaFolderUpload	= 'admavatar';				// If any
	$maxFilePxUpload	= '100x100';				// If any
	
	$pageType 			= 'detail';					// list OR detail OR overview
	$id					= ue_real_escape_string($_SESSION['currentUserIdAdm']);
	$pageTitle			= 'Edit';
	$namaHalamanEdit	= currentPage();
	$_GET['detailmode']	= 'edit';
...
<div class="transFullWidthWrapper" id="ueFormContainer">
    ...
    <form enctype="multipart/form-data" method="post" action="action-editprofile.php">
    	...
    	<table id="detailPageTable" width="100%">
        	<tr>
                ...
                <td>
                	<?php echo $detailmodeeditRes["$namaTableDatabase".'_username']?>
                </td>
            </tr>
        	<tr>
            	<td>
                ...
                <td>
                	<input type="password" name="oldpass" class="ueInputText" />
                </td>
            </tr>
        	<tr>
            	<td>
                ...
                <td>
                	<input type="password" name="pass" class="ueInputText" />
                </td>
            </tr>
        	<tr>
            	<td>
                ...
                <td>
                	<input type="password" name="repass" class="ueInputText" />
                </td>
            </tr>
            <tr>
				<td width="150">
						...
						<table width="90%" id="eachMultiImageTable" class="eachMultiImageTableClass">
                        	<tr>
                            	<td width="1" rowspan="3" valign="top">
                                    ...
                                    <a id="slimboxTarget" class="ue-zoombox" href="<?php echo $imageUploadFolder?><?php echo $detailmodeeditRes["$namaTableDatabase".'_image']?>" title="<?php echo $detailmodeeditRes["$namaTableDatabase".'_username']?>">
                                    	<img src="<?php echo $imageUploadFolder?><?php echo $detailmodeeditRes["$namaTableDatabase".'_image']?>" width="100%" />
                                    </a>
                                    </div>
                                </td>                                <td style="font-weight: bold;">
                                	<a id="slimboxTarget" class="ue-lightbox" href="<?php echo $imageUploadFolder?><?php echo $detailmodeeditRes["$namaTableDatabase".'_image']?>" title="<?php echo $detailmodeeditRes["$namaTableDatabase".'_username']?>">
