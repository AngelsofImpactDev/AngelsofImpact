<?php
	...
	$namaPageUtama		= 'productcategory.php';
	$namaFolderUpload	= 'productCategoryImage';	// If any
...
<div class="transFullWidthWrapper" id="ueFormContainer">
    ...
    <form enctype="multipart/form-data" method="post" action="action-productcategory.php">
    	...
    	<table id="detailPageTable" width="100%">
        	<tr>
                ...
                ?>
               	<?php echo ueCreateSelectOption($currentSelectArr,'',$detailmodeeditRes['productclass_id'])?>
                </td>
            </tr>
        	<tr>
            	<td>
        	...
        	<tr>
                ...
                <td>
                    ...
                    ?>
                    <?php echo ueCreateSelectOption($currentSelectArr,'',$detailmodeeditRes["$namaTableDatabase".'_highlight'])?>
                </td>
            </tr>
            -->
            <tr>
