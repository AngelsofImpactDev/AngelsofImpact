<?php
	...
	$namaTableDatabase	= 'productclass';
	$namaPageUtama		= 'productclass.php';
	$namaFolderUpload	= 'productClassImage';		// If any
	$maxFilePxUpload	= '806x425';				// If any
...
<div class="transFullWidthWrapper" id="ueFormContainer">
    ...
    <form enctype="multipart/form-data" method="post" action="action-productclass.php">
